...
class App:
    def __init__(self):
        ...
        self.notebook.add(self.pojazd, text="Pojazdy", state='hidden')
        self.notebook.add(self.kierowca, text="Kierowcy", state='hidden')
        ...
        self.szukaj_edytuj_button = tk.Button(self.szukaj_przyciski_frame, text='Edytuj', command=self.edit_kierowca, state='disabled')
